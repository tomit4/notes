...
static const char *const autostart[] = {
    "swaybg",
    "-i",
    "/home/brian/Pictures/leaves.jpg",
    "-m",
    "fill",
    NULL,
    "gammastep",
    ...
    "foot",
    "-c",
    "/home/brian/.config/foot/bfoot.ini",
    "/usr/bin/btop",
    NULL,
...
static const char *librewolfcmd[] = {"librewolf-bin", NULL};
static const char *chromiumcmd[] = {"chromium-bin", NULL};
static const char *inkscapecmd[] = {"inkscape", NULL};
static const char *gimpcmd[] = {"gimp", NULL};
static const char *pcmanfmcmd[] = {"pcmanfm", NULL};
static const char *keepassxccmd[] = {"keepassxc", NULL};
static const char *libreofficecmd[] = {"libreoffice-bin", NULL};
static const char *mousepadcmd[] = {"mousepad", NULL};
static const char *virtmanagercmd[] = {"virt-manager", NULL};
static const char *qalculatecmd[] = {"qalculate-qt", NULL};
static const char *steamcmd[] = {"steam", NULL};
static const char *thunderbirdcmd[] = {"thunderbird-bin", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY, XKB_KEY_c, spawn, {.v = chromiumcmd}},
    {MODKEY, XKB_KEY_i, spawn, {.v = inkscapecmd}},
    {MODKEY, XKB_KEY_g, spawn, {.v = gimpcmd}},
    {MODKEY, XKB_KEY_p, spawn, {.v = pcmanfmcmd}},
    {MODKEY, XKB_KEY_k, spawn, {.v = keepassxccmd}},
    {MODKEY, XKB_KEY_n, spawn, {.v = libreofficecmd}},
    {MODKEY, XKB_KEY_m, spawn, {.v = mousepadcmd}},
    {MODKEY, XKB_KEY_v, spawn, {.v = virtmanagercmd}},
    {MODKEY, XKB_KEY_u, spawn, {.v = qalculatecmd}},
    {MODKEY, XKB_KEY_s, spawn, {.v = steamcmd}},
    {MODKEY, XKB_KEY_t, spawn, {.v = thunderbirdcmd}},
    {MODKEY, XKB_KEY_Left, setmfact, {.f = -0.0125f}},
    {MODKEY, XKB_KEY_Right, setmfact, {.f = +0.0125f}},
